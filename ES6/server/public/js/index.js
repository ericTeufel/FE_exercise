...
/***/ (function(module, exports) {
...

	{
	  var _s = '𠮷';
	  // es5
	  console.log('length', _s.length); //2 两个字节为一个长度 超过两个字节了
	  console.log('0', _s.charAt(0)); //0 �
	  console.log('1', _s.charAt(1)); //1 �
	  console.log('at0', _s.charCodeAt(0)); //at0 55362
	  console.log('at1', _s.charCodeAt(1)); //at1 57271
